...
data = concatFrames(root_dir = "./frames_10fps/", csv_files = csv_files_train, _input = _input, _label = _label)
...
torch.save(_input_train, "input_train_300.pt")
torch.save(_label_train, "label_train_300.pt")
...
data_validation = concatFrames(root_dir = "./frames_10fps/", csv_files = csv_files_validation, _input = _input_, _label = _label_)
...
torch.save(_input_validation, "input_validation_300.pt")
torch.save(_label_validation, "label_validation_300.pt")
...
_input_ = np.zeros((sequence_length, feature_len), dtype="float32")
_label_ = np.ones((1), dtype="int32")
data_test = concatFrames(root_dir = "./frames_10fps/", csv_files = csv_files_test, _input = _input_, _label = _label_)
...
torch.save(_input_test, "input_test_300.pt")
torch.save(_label_test, "label_test_300.pt")
...
_input_train = torch.load("input_train_300.pt")
_label_train = torch.load("label_train_300.pt")
_input_validation = torch.load("input_validation_300.pt")
_label_validation = torch.load("label_validation_300.pt")
